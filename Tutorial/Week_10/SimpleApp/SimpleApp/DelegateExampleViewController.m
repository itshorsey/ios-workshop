...
@interface DelegateExampleViewController () <UIPickerViewDataSource, UIPickerViewDelegate>
@end
...
{
    if (self = [super init]) {
        UITabBarItem *item = [[UITabBarItem alloc] initWithTitle:@"One" image:[UIImage imageNamed:@"box.png"] selectedImage:nil];
